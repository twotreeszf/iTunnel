...
- (int)reconnect
{
    int ret = LIBSSH2_ERROR_NONE;
    {
        ...
        {
            X_ASSERT([_privateKey length]);
            
            ret = libssh2_userauth_publickey_fromfile(_session, [_userName UTF8String], NULL, [_privateKey UTF8String], "");
            ERROR_CHECK_BOOL(LIBSSH2_ERROR_NONE == ret);
        }
